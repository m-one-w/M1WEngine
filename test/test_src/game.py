...
class Game:
    ...
    def __init__(self):
        ...
        """
        Initialize the game modules needed.
        If this method is not instantanious, check if joystick.init() is causing
        a slow down. Faulty keyboards may cause 40 second load times in this method.
        """
        pygame.init()
