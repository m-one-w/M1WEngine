...
class HeadsUpDisplay(AbstractHud):
    ...
    Attributes
    ----------
    PAUSE_BUTTON_COORDINATES: pygame.Vector2
        Coordinates to display the pause button
    SCORE_INFO_COORDINATES: pygame.Vector2
        Coordinates to display the score info
    LEVEL_PROMPT_SHOW_TIME_SECONDS: int
        Coordinates to display the level prompt
